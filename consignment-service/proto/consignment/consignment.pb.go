...
/*
Package go_mciro_srv_consignment is a generated protocol buffer package.
...
It has these top-level messages:
	...
	Response
*/
package go_mciro_srv_consignment
...
func init() {
	proto.RegisterType((*Consignment)(nil), "go.mciro.srv.consignment.Consignment")
	proto.RegisterType((*Container)(nil), "go.mciro.srv.consignment.Container")
	proto.RegisterType((*GetRequest)(nil), "go.mciro.srv.consignment.GetRequest")
	proto.RegisterType((*Response)(nil), "go.mciro.srv.consignment.Response")
}
...
func NewShippingServiceClient(serviceName string, c client.Client) ShippingServiceClient {
	...
	if len(serviceName) == 0 {
		serviceName = "go.mciro.srv.consignment"
	}
...
var fileDescriptor0 = []byte{
	...
	0xd2, 0xfa, 0xe7, 0xd4, 0x75, 0x09, 0x2d, 0x55, 0x5a, 0x15, 0x42, 0xab, 0xd4, 0xe8, 0x6d, 0xea,
	...
	0xf7, 0x5f, 0x01, 0x00, 0x00, 0xff, 0xff, 0xd4, 0x12, 0x70, 0x2d, 0x10, 0x03, 0x00, 0x00,
}
